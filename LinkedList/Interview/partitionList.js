...
class LinkedList {
  ...
  partitionList(x) {
    ...
    while (pointer) {
      if (pointer.value < x) {
        if (dummy1) {
          dummy1.next = new Node(pointer.value);
          tail1 = new Node(pointer.value);
        } else {
          dummy1 = new Node(pointer.value);
          head1 = new Node(pointer.value);
        }
      } else {
        if (dummy2) {
          dummy2.next = new Node(pointer.value);
          tail2 = new Node(pointer.value);
        } else {
          dummy2 = new Node(pointer.value);
          head2 = new Node(pointer.value);
        }
      }
